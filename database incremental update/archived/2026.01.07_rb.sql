/*
 ...
 Date: 07/01/2026 10:44:29
*/


ALTER TABLE [portal].[FormSections] ADD [showTitleDescr] bit DEFAULT 0 NULL
GO

EXEC sp_addextendedproperty
'MS_Description', N'To show hide Section title and description',
'SCHEMA', N'portal',
'TABLE', N'FormSections',
'COLUMN', N'showTitleDescr';

Update [portal].[FormSections] set showTitleDescr = 0;

-- ----------------------------
-- procedure structure for spFormConfigurationJSON_Get
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[portal].[spFormConfigurationJSON_Get]') AND type IN ('P', 'PC', 'RF', 'X'))
	DROP PROCEDURE [portal].[spFormConfigurationJSON_Get]
GO

CREATE PROCEDURE [portal].[spFormConfigurationJSON_Get]
    @FormId INT
AS
BEGIN
    SET NOCOUNT ON;
